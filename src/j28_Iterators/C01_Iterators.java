 ...
 */
        ...
        while (it1.hasNext()){
            //hasNext()->it1 elemanları için pointer(cursor:imleç) oldugu yern sonrasında eleman varlıgını
            // kontrol edip true-false return eder
        ...
        List<String> l2 = new ArrayList<>(Arrays.asList("javaCAN", "javvaNUR", "javaNAZZZ",
                "javaSU", "javaHAN", "javaZADE", "javaTAR", "javaLAZIM"));
